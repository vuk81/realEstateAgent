...
class Apartment(Property):
    ...
    def prompt_init():
        ...
        laundry = get_valid_input("What laundry facilities does the propert have?", Apartment.valid_laundries)
...
def get_valid_input(input_string, valid_options):               #Da li ovo smestiti u klasu Apartment
